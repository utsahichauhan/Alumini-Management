                        ...
                        <div data-to="50% 50%" data-ts="preserve-3d" data-t="4" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                            <div data-to="50% 50%" data-ts="preserve-3d" data-t="5" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                                <div data-to="50% 50%" data-ts="preserve-3d" data-t="6" style="left:0px;top:0px;width:500px;height:400px;position:absolute;">
                                    <div data-to="50% 50%" data-t="7" style="left:-50px;top:175px;width:600px;height:38px;position:absolute;opacity:0;color:#2cbfa7;font-size:32px;font-weight:700;line-height:1.2;text-align:center;">Create your kind of holiday with your friends</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <!-- <div class="container"> -->
      <div class="square-container-fluid">
          <div class="square">
              ...
              <div class="compartment bottom-right">1000+ Student Join Our ALumni events</div>
          </div>
      </div>
  ...
  <!-- <div class="container-fluid"> -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8 text-center">
            <h3 class="mt-0 text-white"><a href="events.php">click here for check events</a></h3>
      ...
      <style>
        @media screen and (max-width: 768px) {
          ...
          .sidebar ul {
            ...
            width: 100%;
            height: 70px;
            background-color: #050505; /* Adjust background color as needed */
            padding: 20px;
            z-index: 999;
            overflow-y: auto;
